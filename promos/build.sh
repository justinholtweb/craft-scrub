...
# Output: promos/out/scrub-promo-N.png at 1920x1080 (rendered at 2x, downsampled).
set -euo pipefail
...
for n in $SLIDES; do
  "$CHROME" \
    ...
    --screenshot="out/scrub-promo-$n.png" \
    "file://$PWD/slides.html?s=$n" >/dev/null 2>&1
  sips --resampleWidth 1920 "out/scrub-promo-$n.png" >/dev/null
  echo "  built out/scrub-promo-$n.png"
done
